...
class RecipeTest extends GroovyTestCase {
    ...
    void testSetGetType() {
        _recipe.setType(RecipeType.PartialMash);
        assertEquals(RecipeType.PartialMash, _recipe.getType());
    }
    ...
    void testSetGetStyle() {
        ...
        assertEquals(900, _recipe.getStyle().getId());
    }

    void testSetGetEquipment() {
        def equipmentItem = new EquipmentItem();
        equipmentItem.setId(901);

        _recipe.setEquipment(equipmentItem);
        assertEquals(901, _recipe.getEquipment().getId());
    }
    ...
    void testSetGetHops() {
        ...
        assertEquals(3, _recipe.getHops().size());
    }
    ...
    void testSetGetFermentables() {
        ...
        assertEquals(4, _recipe.getFermentables().size());
    }

    void testSetGetMiscs() {
        ArrayList<MiscellaneousItem> miscellaneousItems = new ArrayList<MiscellaneousItem>();
        miscellaneousItems.add(new MiscellaneousItem());
        miscellaneousItems.add(new MiscellaneousItem());
        miscellaneousItems.add(new MiscellaneousItem());
        miscellaneousItems.add(new MiscellaneousItem());
        miscellaneousItems.add(new MiscellaneousItem());

        _recipe.setMiscs(miscellaneousItems);
        assertEquals(5, _recipe.getMiscs().size());
    }
    ...
    void testSetGetYeasts() {
        ...
        assertEquals(6, _recipe.getYeasts().size());
    }
    ...
    void testSetGetWaters() {
        ...
        assertEquals(7, _recipe.getWaters().size());
    }
    ...
    void testSetGetMash() {
        ...
        assertEquals(902, _recipe.getMash().getId());
    }
