...
class FermentableTest extends GroovyTestCase {
    ...
    void testSetGetType() {
        _fermentable.setType(FermentableType.Extract);
        assertEquals(FermentableType.Extract, _fermentable.getType());
    }
    ...
    void testSetGetId() {
        _fermentable.setId(11);
        assertEquals(11, _fermentable.getId());
    }
}
